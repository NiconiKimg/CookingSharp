...
{
    /// <inheritdoc />
    public partial class RefactorRatings : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MenuRatings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MenuRatings_Menus_MenuId",
                        column: x => x.MenuId,
                        principalTable: "Menus",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MenuRatings_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MenuRatings_MenuId",
                table: "MenuRatings",
                column: "MenuId");

            migrationBuilder.CreateIndex(
                name: "IX_MenuRatings_UserId_MenuId",
                table: "MenuRatings",
